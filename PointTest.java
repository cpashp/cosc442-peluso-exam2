...
public class PointTest {
	...
	/**
	 * Run the boolean equals2(Point) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 5/18/18 6:22 PM
	 */
	@Test
	public void testEquals2_1()
		throws Exception {
		Point fixture = new Point(1, 1, 1);
		Point other = new Point(1, 1, 1);

		boolean result = fixture.equals2(other);

		// add additional test code here
		// An unexpected exception was thrown in user code while executing this test:
		//    java.lang.NoSuchMethodException: equals2
